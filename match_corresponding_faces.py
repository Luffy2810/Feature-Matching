...
class Matcher():
    ...
    def match(self,img1,img2):
        ...
        for face_id, (img0_face, img1_face) in enumerate(zip(img0_faces, img1_faces)):
            ...
            eq_mkpts0 = cubemap_to_equirectangular(mkpts0, str(face_id), cubemap1.shape[1]/4, img_width=img1.shape[1],img_height=img1.shape[0])
            eq_mkpts1 = cubemap_to_equirectangular(mkpts1, str(face_id), cubemap1.shape[1]/4, img_width=img1.shape[1],img_height=img1.shape[0])
...
if __name__ =="__main__":
    ...
    save_name = "vis/eloftr_corr_faces_0.75.png"
